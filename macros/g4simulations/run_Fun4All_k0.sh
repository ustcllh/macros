...
#set event=0
#set event=50
#root -l -b Fun4All_G4_sPHENIX_gun.C
...
### pythia8_dijet_highz
#root -l -b -q Fun4All_G4_sPHENIX_PFJet.C\($event,0.45,40.0,0.8,\"./pythia_cfg/phpythia8_QCD30.cfg\",\"/sphenix/user/lihan/PFJet/output/out_$2/QCD30GeV_jet40GeVeta0p45_G4sPHENIX_$2_$1.root\",\"\"\)
### pythia8_dijet_allz
