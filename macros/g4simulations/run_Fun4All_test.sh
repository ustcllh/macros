...
#root -l -b Fun4All_G4_sPHENIX_gun.C\($event,\"\",\"/sphenix/user/lihan/PFJet/output/out_SingleParticle/G4Hits_sPHENIX_$3_eta0.60_$2GeV-$foo\",\"\"\,\"$3\",$2\)
...
### pythia8_dijet_highz
root -l -b -q Fun4All_G4_sPHENIX_PFJet.C\($event,0.45,40.0,0.8,\"./pythia_cfg/phpythia8_QCD30.cfg\",\"/sphenix/user/lihan/PFJet/output/out_PHFlowJets/QCD30GeV_jet40GeVeta0p45_G4sPHENIX_$foo.root\",\"\"\)
### pythia8_dijet_allz
