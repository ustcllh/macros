...
int Fun4All_G4_sPHENIX_SingleParticle(
    const int nEvents = 1,
    const char *inputFile = "/sphenix/sim/sim01/cd1_review/single_particle/fieldmap/G4Hits_sPHENIX_e-_eta0_32GeV-0000.root",
...
//            PHG4SimpleEventGenerator::Uniform);
  ...
  MyTreeMaker *tm = new MyTreeMaker( outputFile ,true,true,false,false,false,false,false);
